(function(global, factory) {
  /* CommonJS */ if (typeof require === 'function' && typeof module === "object" && module && module["exports"])
    module['exports'] = (function() {
      return factory(require('./cbusCore'), require('./cbusCommand'), require('bytebuffer'));
    })();
  /* Global */ else
    global["cbus"] = factory(global.cbusCore, global.cbusCommand, global.dcodeIO.ByteBuffer);
  })(this, function(databus, cbusCommand, ByteBuffer) {
    const { AppList, ProtoFileList } = cbusCommand;
    // 根据proto获取command值
    const commandCache = {}
    const msgExpress = {
    ...
    class AppClient {
      ...
      // jsonObjList参数：[{name: name, json: require('./protobuf/msgexpress.json')}]
